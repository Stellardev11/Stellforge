...
export const pointMints = pgTable('point_mints', {
  ...
  pSlfPointsAwarded: decimal('p_slf_points_awarded', { precision: 20, scale: 2 }).notNull(),
...
export const pointBalances = pgTable('point_balances', {
  ...
  walletAddress: text('wallet_address').notNull().unique(),
  pSlfPoints: decimal('p_slf_points', { precision: 20, scale: 2 }).default('0').notNull(),
...
export const tasks = pgTable('tasks', {
  ...
  pSlfReward: decimal('p_slf_reward', { precision: 20, scale: 2 }).notNull(),
...
export const mintSettings = pgTable('mint_settings', {
  ...
  totalPSlfMinted: decimal('total_p_slf_minted', { precision: 20, scale: 2 }).default('0').notNull(),
  updatedAt: timestamp('updated_at').defaultNow().notNull(),
});
...
export const userStats = pgTable('user_stats', {
  ...
  totalPSlfDistributed: decimal('total_p_slf_distributed', { precision: 20, scale: 2 }).default('0').notNull(),
  updatedAt: timestamp('updated_at').defaultNow().notNull(),
});
...
export const projects = pgTable('projects', {
  ...
  totalPSlfDistributed: decimal('total_p_slf_distributed', { precision: 20, scale: 2 }).default('0').notNull(),
  creatorPSlfEarned: decimal('creator_p_slf_earned', { precision: 20, scale: 2 }).default('0').notNull(),
...
export const projectParticipations = pgTable('project_participations', {
  ...
  participantPSlfEarned: decimal('participant_p_slf_earned', { precision: 20, scale: 2 }).notNull(),
  creatorPSlfEarned: decimal('creator_p_slf_earned', { precision: 20, scale: 2 }).notNull(),
